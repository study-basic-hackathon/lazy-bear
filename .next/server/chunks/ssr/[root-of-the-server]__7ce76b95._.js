...
;
;
function PersonaForm({ form, onChange, onSubmit }) {
...
;
;
function PersonaCreateTemplate({ form, onChange, onSubmit }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/src/app/lib/convertType/persona.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$convertType$2f$persona$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lib/convertType/persona.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function PersonaCreatePage() {
    ...
    const [form, setForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$convertType$2f$persona$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiToViewModel"])({
        weekdayHours: 1,
        weekendHours: 1,
    ...
    const handleSubmit = async ()=>{
        try {
            ...
            if (!form.weekdayHours || !form.weekendHours) {
                handleChange({
                    errors: {
                        learningPattern: "平日または休日の勉強時間を入力してください"
                    }
                });
                return;
            }
            if (Number(form.weekdayHours) === 0 && Number(form.weekendHours) === 0) {
                handleChange({
                    errors: {
                        hours: "合計1時間以上になるよう入力してください"
                    }
                });
                return;
            }
            const data = await postPersona((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$convertType$2f$persona$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["viewModelToApi"])(form));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7ce76b95._.js.map