...
`,B={type:z.SchemaType.OBJECT,properties:{steps:{type:z.SchemaType.ARRAY,description:"学習ステップの配列",items:{type:z.SchemaType.OBJECT,properties:{title:{type:z.SchemaType.STRING,description:"ステップのタイトル"},theme:{type:z.SchemaType.STRING,description:"そのステップで達成すべき学習目標"},index:{type:z.SchemaType.INTEGER,description:"ステップの順序 (0始まり)"}},required:["title","theme","index"]}}},required:["steps"]};async function C(a,b){let c=`
  ## 指示
